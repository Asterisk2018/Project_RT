# базовые классы, процедуры, функции и локаторы для автотестов
...
class AuthForm(BaseForm):
    def __init__(self, driver, timeout=5):
        ...
        self.page_right = driver.find_element(By.XPATH, "//*[@id='page-right']/div//h1")
        self.page_left = driver.find_element(By.XPATH, "//*[@id='page-left']//div[2]/h2")
        ...
        self.tab_l_s = driver.find_element(By.ID, 't-btn-tab-ls')
